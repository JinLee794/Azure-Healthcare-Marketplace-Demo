            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        ...
                        "city": {
                            "type": "string",
                            "description": "City where provider practices"
                        },
                        "state": {
                            "type": "string",
            ...
            },
            {
                ...
                "inputSchema": {
                    ...
                    "properties": {
                        "npi": {
                            "type": "string",
                            "description": "The NPI number to validate"
                        }
                    },
                    "required": ["npi"]
                }
...
async def validate_npi(npi: str) -> dict:
    ...
    if not _luhn_check(f"80840{npi}"):
        return {
            "valid": False,
            "npi": npi,
            "reason": "NPI fails checksum validation"
        }
...
async def health_check(req: func.HttpRequest) -> func.HttpResponse:
    ...
    return func.HttpResponse(
        json.dumps({"status": "healthy", "server": server.name, "version": server.version}),
        mimetype="application/json"
    )
